...
<form class="form-inline">
 ...
 <div class="form-group">
  	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">数据月结</button>
  </div>
  

  
  <div class="form-group">
  	<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#eidtModal">取消月结</button>
  </div>
  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title" id="myModalLabel"><b>数据月结</b></h3>
        	...
        	<div class="form-group form-group-sm form-inline" >
                    <div class="row">	
                        <div class="col-md-12">		
                            ...
                            <div class="input-group date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1" data-link-format="yyyy-mm-dd">
					           		<input id="ins_date" class="form-control" size="20"  placeholder="月结时间" type="text" value=""  disabled >
					           		<span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
					           		<span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
					       	</div>
                        </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="add_save">确认月结</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade bs-example-modal-lg" id="eidtModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h3 class="modal-title" id="myModalLabel"><b>取消月结</b></h3>
        	...
        	<div class="form-group form-group-sm form-inline" >
                    <div class="row">	
                        <div class="col-md-12">		
                            <label for="vessel" class="control-label">月结年月:</label>
                             <div class="input-group date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1" data-link-format="yyyy-mm-dd">
					           		<input id="upd_date" class="form-control" size="20"  placeholder="取消月结时间" type="text" value=""  disabled >
					           		<span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
					           		<span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
					       	</div>
                        </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">关 闭</button>
        <button type="button" class="btn btn-primary" id="cancel_save">取消月结</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade bs-example-modal-lg" id="delModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">关 闭</button>
        <button type="button" class="btn btn-primary" id="b_save2">删 除</button>
      </div>
    </div>
  </div>
</div>
...
<!--progress Modal -->
<div class="modal fade bs-example-modal-lg" id="barModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        	...
        	<div class="progress">
			  <div class="progress-bar" id="cal_bar" role="progressbar" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100" style="width: 20%;">
			    20%
			  </div>
			 
			</div>
             <div style="text-align:center" id="text_bar">1.请勿关闭窗口,数据检测中</div>
...
<script src="js/monthSettlement.js"></script>
