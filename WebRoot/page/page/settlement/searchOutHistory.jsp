                ...
                <div class="form-group form-group-sm form-inline" style="margin-bottom:0">
                    ...
                    <div class="row" style="margin-top:10px;">
                        ...
                        <div class="col-md-2">
                         ...
                         <div class="col-md-2">
                            ...
                            <input type="text" class="form-control" id="sel_xxyt" placeholder="详细用途" size="25" >
                        </div>
                        
                         <div class="col-md-2">
                            <label  class="control-label">领料单号:</label>
                            <input type="text" class="form-control" id="sel_llbh" placeholder="领料单号" size="25" >
                        </div>
                    ...
                    <div class="row" style="margin-top:10px;">
                         ...
                         <div class="col-md-2">
                             ...
                             <button type="button" class="btn btn-primary" >打  印</button>
                         </div>
                    </div>
...
<script src='<%=basePath %>dwr/interface/InAndOutCheck.js'></script> 
 <script type="text/javascript" src="js/searchOut.js"></script> 
