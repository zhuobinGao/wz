...
#project-label {
	      ...
	      <div class="modal-body">
	        	<form class="form-horizontal" role="form" id="addForm">
	        		<div class="form-group">
					    <label for="i_cbdm" class="col-sm-2 control-label">船舶代码<span class="text-danger">(*)</span></label>
					    <div class="col-sm-3">
					      <input type="text" class="form-control" id="i_cbdm" placeholder="船舶代码">
						</div>
						
						<label for="i_cbzwm" class="col-sm-2 control-label">船舶中文名<span class="text-danger">(*)</span></label>
					    <div class="col-sm-3">
					      <input type="text" class="form-control" id="i_cbzwm" placeholder="船舶中文名">
						</div>
					...
					<div class="form-group">
					    ...
					    <div class="col-sm-3">
					      <select id="i_chlx" class="form-control">
					      		<option value="S">驳船</option>
					      		<option value="B">大船</option>
					      </select>
						</div>
					
					    <label for="i_cgs" class="col-sm-2 control-label">船公司</label>
					    <div class="col-sm-3">
					      <input type="text" class="form-control" id="i_cgs" placeholder="船公司">
						</div>
					...
					<div class="form-group">
					    <label for="i_csc" class="col-sm-2 control-label">船身长</label>
					    <div class="col-sm-3">
					      <input type="text" class="form-control" id="i_csc" placeholder="船身长" value="0">
						</div>
						
						<label for="i_gd" class="col-sm-2 control-label">高度</label>
					    <div class="col-sm-3">
					      <input type="text" class="form-control" id="i_gd" placeholder="高度" value="0">
						</div>
						
					</div>
					
					<div class="form-group">
					    <label for="i_kd" class="col-sm-2 control-label">宽度</label>
					    <div class="col-sm-3">
					      <input type="text" class="form-control" id="i_kd" placeholder="宽度" value="0">
						</div>
						
						<label for="i_zz" class="col-sm-2 control-label">总重</label>
					    <div class="col-sm-3">
					      <input type="text" class="form-control" id="i_zz" placeholder="总重" value="0">
						</div>
						
					</div>
					
					<div class="form-group">
					    <label for="i_jz" class="col-sm-2 control-label">净重</label>
					    <div class="col-sm-3">
					      <input type="text" class="form-control" id="i_jz" placeholder="净重" value="0">
						</div>
						
						<label for="i_cr" class="col-sm-2 control-label">舱容</label>
					    <div class="col-sm-3">
					      <input type="text" class="form-control" id="i_cr" placeholder="舱容" value="0">
						</div>
						
					</div>
					
					<div class="form-group">
					    <label for="i_bz" class="col-sm-2 control-label">备注</label>
					    <div class="col-sm-3">
					      <input type="text" class="form-control" id="i_bz" placeholder="备注">
						</div>
  ...
  <script src="<%=basePath %>page/js/jquery-1.12.1.min.js"></script>
   ...
   <script src="<%=basePath %>/page/page/asset/js/fixedAsset.js?v=1.0"></script>
