...
<div class="row" >
	<div class="col-lg-12">
         <div class="form-group form-group-sm form-inline">
             ...
             <button type="button" class="btn btn-primary" id="chenkOut" >查  询</button>
...
<script type="text/javascript" src="js/outWarehouseEdit.js?v=1.0"></script> 
