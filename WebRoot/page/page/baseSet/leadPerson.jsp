    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        	...
        	<div class="form-group form-group-sm form-inline" >
                    <div class="row">	
                        <div class="col-md-6">		
                            <label for="vessel" class="control-label">&nbsp;&nbsp;&nbsp;&nbsp;领料人:</label>
                            <input type="text" class="form-control" id="ins_llr" placeholder="领料人" size="35" >
                        </div>
                        <!-- decode(c.config_type,'1003','收料人','1004','采购人','1005','供货单位','1007','发料人','1008','领料人','1009','领料单位主管')  -->
                        <div class="col-md-6">		
                            <label for="vessel" class="control-label" >领料人单位主管:</label>
                            <select class="form-control" id="ins_llzg">
		    ...
		    <div class="form-group form-group-sm form-inline" >
		    	<div class="row">
                   	<div class="col-md-6">		
                           <label for="vessel" class="control-label" >领料单位:</label>
                           <select class="form-control" id="ins_lldw">
      ...
      <div class="modal-body">
        	...
        	<div class="form-group form-group-sm form-inline" >
                    <div class="row">	
                        <div class="col-md-6">		
                            <label for="vessel" class="control-label">&nbsp;&nbsp;&nbsp;&nbsp;领料人:</label>
                            <input type="text" class="form-control" id="upd_llr" placeholder="领料人" size="35" >
                        </div>
                        <!-- decode(c.config_type,'1003','收料人','1004','采购人','1005','供货单位','1007','发料人','1008','领料人','1009','领料单位主管')  -->
                        <div class="col-md-6">		
                            <label for="vessel" class="control-label" >领料人单位主管:</label>
                            <select class="form-control" id="upd_llzg">
		    ...
		    <div class="form-group form-group-sm form-inline" >
		    	<div class="row">
                   	<div class="col-md-6">		
                           <label for="vessel" class="control-label" >领料单位:</label>
                           <select class="form-control" id="upd_lldw">
...
<script src="js/leadPerson.js"></script>
